...
<div class="workingArea">
	...
	<table class="addPictureTbale" align="center">
		<tr>
			<td class="addPictureTableTD">
				<div>
					<div class="panel panel-warning addPictureDiv">
						<div class="panel panel-heading">新增产品<b class="text-primary">单个</b>图片</div>
						<div class="panel panel-body">
							<form method="post" class="addFormSingle" action="admin_productImage_add" enctype="multipart/form-data">
								<table class="addTable">
									...
									<tr>
										<td align="right"><input id="filepathSingle" name="filepath" type="file"></td>
									</tr>
									<tr class="submitTR">
										<td align="center">
											<input class="hidden" name="type" value="type_single">
											<input class="hidden" name="pid" value="${p.id}">
			...
			<td class="addPictureTableTD">
				<div>
					<div class="panel panel-warning addPictureDiv">
						<div class="panel panel-heading">新增产品<b class="text-primary">详情</b>图片</div>
						<div class="panel panel-body">
							<form method="post" class="addFormDetail" action="admin_productImage_add" enctype="multipart/form-data">
								<table class="addTable">
									...
									<tr>	
										<td align="right"><input id="filepathDetail" name="filepath" type="file"></td>
									</tr>
									<tr class="submitTR">
										<td align="center">
